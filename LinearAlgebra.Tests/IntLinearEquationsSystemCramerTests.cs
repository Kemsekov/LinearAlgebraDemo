...
public class LinearEquationsSystemIntCramerTests
{
    [Fact]
    public void OneSolution_Test(){
        var m = new SquareMatrixInt(new int[]{1,2,1,1,0,2,0,1,1});
        var freeCoefficients = new VectorInt(new int[]{5,4,7});
        var l = new LinearEquationsSystemIntCramer(m,freeCoefficients);
    ...
    public void NoSolutions_Test(){
        ...
        var freeCoefficients = new VectorInt(new int[]{3,6,12});
        var l = new LinearEquationsSystemIntCramer(m,freeCoefficients);
